...
The mirrors used by [DISTRO Core](https://github.com/distro-core). The curated mirrors are
updated with Github Actions; the workflows are scheduled in order to batch updates at known
intervals.

No changes accepted, No upstream contribution path available. Seek to submit changes through
the origin repository according to it's specific guidlines or contribution policy.

[![scheduled-update-mirrors](https://github.com/distro-core-curated-mirrors/.github/actions/workflows/scheduled-update-mirrors.yml/badge.svg)](https://github.com/distro-core-curated-mirrors/.github/actions/workflows/scheduled-update-mirrors.yml)
